...
const Banner = () => {
    ...
    return (
        <section className={classNames(display.alignCenter, display.flex, display.flexColumn, bg.noRepeat, 
            ...
            <div className={classNames(display.alignCenter, display.flex, display.flexColumn, classes.mdAlignLeft,
                classes.bannerContent)}>
                <Typography className={classNames(text.alignCenter, text.font7, text.textLight, display.opacity8
                    , classes.mdTextLeft)} component="h2" variant="h5">
                    Let’s talk about<br />your project
                </Typography>
                <Typography className={classNames(display.mt1, text.alignCenter, text.rem9, text.textLight, 
                    display.opacity8, classes.bannerDescription, classes.mdTextLeft)}>
